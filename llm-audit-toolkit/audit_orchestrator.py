#!/usr/bin/env python3
"""
LLM Audit Toolkit - Multi‑LLM Codebase Auditor
Reusable package for conducting comprehensive code audits using multiple LLM providers.
...
Quick start:
  ...
  python audit_orchestrator.py run --providers openai gemini grok --consensus openai
"""
