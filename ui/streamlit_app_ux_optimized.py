...
with tab1:
    ...
    uploaded_file = st.file_uploader(
        ...
        help="Supported formats: PNG, JPG, TIFF. Optimal size: 1000-4000px width, <50MB",
    ...
    if analyze_button:
        ...
        with progress_container:
            ...
            try:
                ...
                with col1:
                    st.button("📊 **View Results**", use_container_width=True, help="Switch to Results & Export tab")
